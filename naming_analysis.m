function naming_analysis(EEG, study, pth, cmat) 
    ...
    for gsize = [1 2]
        ...
        fdat_pth = sprintf('%s/condition/data/%s/Group Size %d', pth, EEG.band{end}, gsize);
        ...
        while k <= length(keyset)
            ...
            for ii = k:k+gsize-1
                ...
                temp_evns = evn_idc(ismember(evn, temp_typ));
            ...
            event_prep(ses_EEG, focus_evns, focus_resp, fdat_pth, pcatn);
