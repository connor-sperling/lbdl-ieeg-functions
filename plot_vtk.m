...
loc_dir = '/Volumes/LBDL_Extern/bdl-raw/iEEG_Marseille/Electrode_Localization';
elec_dir = sprintf('%s/%s/Electrodes', loc_dir, pt);
vtkf = dir('*.vtk');
vtkf = vtkf.name;

electrodesSurf = importisosurface(sprintf('%s/%s',elec_dir,vtkf));
