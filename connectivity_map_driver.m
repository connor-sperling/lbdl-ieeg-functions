...
if strcmp(study, 'Stroop_CIC-CM')
    ...
    % subjs_dir : path to subject data
    % study     :
    % ref       : bipolar or monopolar
    % locks     :
    % bands     : [LFP, HFB]
    % ztol      : tolerance for ___
    % atlas     : reference brain map
    % abr       : 'annotate brain regions'
